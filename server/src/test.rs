use projcore::data_types::{old_book::OldBook, Meta, PubType};
...
pub fn book() -> OldBook {
    OldBook::new(
        ...
        Meta::new(
            ...
            *b"ruRU",
            "Постойко".to_string(),
            "«Едва только дворник отворил калитку, как Постойко с необыкновенной ловкостью проскользнул мимо него на улицу. Это случилось утром. Постойке необходимо было подраться с пойнтером из соседнего дома – его выпускали погулять в это время…»".to_string(),
            PubType::Book,
            "Эксмо".to_string(),
            vec!["Дмитрий Наркисович Мамин-Сибиряк".to_string()]
        ),
...
— Вы совершенно правы, сударыня, — ответил за него один из мопсов, приятно оскалясь. — Случилось простое недоразумение... Мы все попали сюда по ошибке.
...
Нечего сказать, приятное путешествие «домой»!.. Все собаки чувствовали себя очень скверно, а один маленький мопсик даже взвыл. Помилуйте, что же это такое!.. А фургон все катился медленно и тяжело, точно на край света. Собак было много, и они поневоле толкали друг друга, когда фургон раскачивался на ухабах; а таких ухабов чем дальше, тем было больше. Таким образом, в этой толкотне Постойко и не заметил, как очутился рядом с Аргусом, даже ткнул его своей мордой в бок.
...
Наступил пятый. Постойко лежал на соломе и не поднимал даже головы, когда дверь отворялась; он столько раз ошибался, что теперь был не в силах ошибиться еще раз. Да, ему слышались и знакомые шаги и знакомый голос, и все это оказывалось ошибкой. Может ли быть что-нибудь ужаснее!.. Холодное отчаяние овладело Постойкой, и он ждал своей участи. Ах, только бы скорее... И в минуту такого отчаяния он вдруг слышит:
...
— Кабы мы с тобой не земляки были, так висеть бы тебе на веревочке! — наставительно говорила Андреевна прыгавшему около нее Постойке. — Смотри у меня, пострел.".to_string()
    )
}
